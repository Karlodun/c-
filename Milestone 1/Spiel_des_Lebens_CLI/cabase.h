...
//          bool getWorld(); // returns whole World as bool array, disabled since no good realisation found
//          bool getnewWorld(); // returns whole newWorld, disabled since no good realisation found
//          void setWorld(bool map[]); // sets World , disabled since no good realisation found
